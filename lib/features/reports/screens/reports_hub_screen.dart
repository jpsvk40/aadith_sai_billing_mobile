...
class ReportsHubScreen extends ConsumerWidget {
  ...
  static const _reports = <ReportConfig>[
    ...
    ReportConfig(
      ...
      labelKeys: ['city', 'name'],
      amountKeys: ['totalAmount', 'amount'],
      subtitleKeys: ['totalOrders', 'orderCount'],
      supportsPeriod: true,
    ),
    ReportConfig(
    ...
    ReportConfig(
      ...
      labelKeys: ['transporterName', 'name'],
      amountKeys: ['grossFreight', 'freight', 'customerPaidFreight'],
      subtitleKeys: ['dispatches', 'delivered', 'boxes'],
    ),
    ReportConfig(
      ...
      color: Color(0xFFEF4444),
      labelKeys: ['customerName', 'name'],
      amountKeys: ['balanceAmount', 'grandTotal', 'outstanding'],
      subtitleKeys: ['invoiceNo', 'agingBucket', 'dueDate'],
    ),
  ];
