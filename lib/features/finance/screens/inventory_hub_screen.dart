...
class InventoryHubScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final tiles = <(IconData, String, String, Color, VoidCallback)>[
      ...
      if (user?.hasModule('products') == true)
        (Icons.sell_outlined, 'Products', 'Product master & pricing', const Color(0xFF7C3AED), () => context.push('/products')),
      if (user?.hasModule('stocktake') == true)
        (Icons.fact_check_outlined, 'Stock-take', 'Physical count & variances', const Color(0xFF0891B2), () => context.push('/inventory/stocktake')),
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const Text('Post stock entries here; item master is managed on web', style: TextStyle(fontSize: 12.5, color: AppColors.textSecondary)),
